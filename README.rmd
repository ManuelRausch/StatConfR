...
```{r, echo=TRUE, results="hide", fig.cap = "Predicted vs observed confidence as a function of discriminability and correctness"}
...
- Use one of the files named 'int_ll*model*.R' from the package sources and adapt the likelihood function according to your model. According to our convention, name the new file a 'int_ll*yourmodelname*.R'. Note that all parameters are fitted on the reals, i.e. positive parameters should be transformed outside the log-likelihood function (e.g. using the logarithm) and back-transformed within the log-likelihood function (e.g. usingthe exponential).
